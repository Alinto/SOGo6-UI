...
//  grossir, le hover qui fait grossir c'est nase, couleur du fond avec le theme, pas en gras
...
const multiSelectVariants = cva('m-1 transition-all duration-300 ease-in-out', {
  variants: {
    variant: {
      default: 'bg-primary',
      secondary:
        'bg-secondary text-secondary color-background hover:bg-secondary/80',
      destructive:
                        ...
                        return (
                          <Badge
                            ...
                            className={cn(
                              ...
                              customStyle?.gradient && 'border-transparen',
