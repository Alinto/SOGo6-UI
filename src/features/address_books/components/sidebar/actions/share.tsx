...
const ShareAddressBookAction: React.FC<ShareAddressBookActionProps> = ({
  ...
  const { data, isLoading, isError, refetch } = useGetAddressBookShareQuery({
    bookId: id,
  })
    ...
    setLocalUsers((prev) =>
      prev.map((u) =>
        u.uid === uid
          ? {
              ...u,
              rights: applyAddressBookPermissionToggle(u.rights, key, checked),
            }
          : u
      )
    )
                              ...
                              {isSubscribing ? (
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={(checked) => {
                                    if (checked)
                                      void handleSubscribeUser(user.uid)
                                  }}
                                />
                              )}
                            </div>
