...
export function ShareFolderDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] min-h-125 max-w-[calc(100vw-2rem)] flex-col overflow-hidden sm:max-w-2xl">
                ...
                {[...localUsers]
                  ...
                  .map((user) => {
                    ...
                    const isAnyAuthenticated =
                      user.uid === ANY_AUTHENTICATED_UID
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-1.5">
                              ...
                              {isCurrentUser && (
                                ...
                                >
                                  {t(
                                    'folders.actions.sharing.badge.you.string'
                                  )}
                                </Badge>
                              )}
                              {isPublic && (
                                ...
                                >
                                  {t(
                                    'folders.actions.sharing.badge.public.string'
                                  )}
                                </Badge>
                              )}
                            </div>
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                {isCurrentUser && (
                                  <TooltipContent>
                                    {t(
                                      'folders.actions.sharing.removeUser.tooltip.string'
                                    )}
                                  </TooltipContent>
                                )}
                              </Tooltip>
